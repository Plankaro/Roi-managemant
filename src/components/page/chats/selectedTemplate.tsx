...
const SelectedTemplateForm: React.FC<TemplateProps> = ({
  selectedTemplate,
  formData,
  setFormData,
  errors,
...
console.log(errors);
    ...
    if (selectedTemplate) {
      ...
      selectedTemplate.components.forEach((component: any) => {
        if (component.type === "HEADER") {
          ...
          newFormData.buttons = component.buttons.map(
  ...
  const renderPreview = () => {
    const previewContent = selectedTemplate?.components.map(
      (component, index) => {
        switch (component?.type) {
          case "HEADER":
            if (
              ...
              const headerContent =
                isValidUrl(formData?.header?.value.trim())
                  ? formData?.header?.value
          ...
          case "BODY":
            ...
            formData.body.forEach((param: any) => {
  ...
  return (
    <ScrollArea className="grid grid-cols-1 lg:grid-cols-[1fr,1fr] xl:grid-cols-[1.2fr,1fr] gap-6 mt-2 relative">
      <div className="space-y-6 ">
        <Card className="bg-white shadow-none border-0 lg:h-[72vh] lg:overflow-y-scroll no-scrollbar">
                          ...
                          <div className="space-y-3">
                            ...
                            {["IMAGE", "VIDEO", "DOCUMENT"].includes(
                              ...
                              <>
                                ...
                                >
                                  Upload a {component?.format?.toLowerCase()}{" "}
                                  under 5 MB with a recommended aspect ratio of
                                  1.91:1.
                                  {errors?.templateForm?.header?.value &&
                                    !formData?.header?.value &&
                                    " (Required)"}
      ...
      <div className="space-y-6 h-full">
        ...
        <div className=" mt-6 lg:absolute bottom-3 flex justify-end right-3">
          <Button
            type="submit"

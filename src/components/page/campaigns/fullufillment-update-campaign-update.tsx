...
import { useCreateCampaignMutation, useGetAllTemplatesQuery, useGetSpecificCampaignQuery, useUpdateCampaignMutation } from "@/store/features/apislice";
...
const FullfillmentCreate = ({id}: {id: string}) => {
  ...
  const [templateSelectionDialog, setTemplateSelectionDialog] = useState(false);
    ...
    const { data: campaignData } = useGetSpecificCampaignQuery(id);
...
export default FullfillmentCreate;

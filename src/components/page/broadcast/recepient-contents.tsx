...
const RecipientContents = () => {
  return (
      ...
      <ScrollArea className="h-[550px] flex-1 no-scrollbar overflow-scroll bg-primary-200 rounded-3xl">
        <div className="p-8 space-y-8">
          ...
          <div className="space-y-6">
            <h2 className="text-lg font-medium ">Smart Audience Filtering</h2>

            <div className="space-y-4">
              {/* Dead Audience Filtering */}
              <div className="space-y-2">
                <h3 className="text-base font-medium ">Dead Audience Filtering</h3>
                <p className="text-sm ">
              ...
              <div className="space-y-2">
                <h3 className="text-base font-medium ">Marketing Message Frequency Control</h3>
                <p className="text-sm ">
              ...
              {/* Duplicate Filtering */}
              <div className="space-y-2">
                <h3 className="text-base font-medium ">Duplicate Filtering</h3>
                <p className="text-sm ">

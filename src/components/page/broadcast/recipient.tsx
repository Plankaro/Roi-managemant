...
export default function RecipientContents() {
  ...
  return (
    <ScrollArea className="h-[70vh] w-full no-scrollbar overflow-scroll bg-blue-50 rounded-3xl">
      <div className="p-8 space-y-8">
        <div className="space-y-2">
          <div className="flex items-center gap-1">
            <h2 className="text-3xl font-medium ">Recipients</h2>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                className="bg-blue-500 hover:bg-blue-500  whitespace-nowrap"
              >
                + Upload Recipients
              </Button>
              {recipientFile && (
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            {" "}
            <div className="flex items-center gap-1">
                <h2 className="text-lg font-medium text-3xl ">Add Content</h2>
                <span className="text-red-500">*</span>
          ...
          <div className="space-y-2 mt-11">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <Checkbox id="shopify-segment" className="ml-20" />

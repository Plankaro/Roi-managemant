  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // Updated selected day style: background-color set to #3A5B9D and text to white.
        day_selected:
          "bg-[#3A5B9D] text-white hover:bg-[#3A5B9D] hover:text-white focus:bg-[#3A5B9D] focus:text-white",

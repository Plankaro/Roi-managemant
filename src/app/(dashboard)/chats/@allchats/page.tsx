...
import { Bell, Podcast as Broadcast, ChevronDown, Layout, LineChart, LogOut, MessageSquare, PlusCircle, Search, Send, Settings, Users, Bot, Database, EllipsisVertical, BotIcon } from "lucide-react";
import {
    DropdownMenu,
    DropdownMenuContent,
    DropdownMenuItem,
...
const AllChats = () => {
    ...
    return (
        <div className="flex-1 flex flex-col border border-primary rounded-[20px] backdrop-blur-3xl backdrop-brightness-75  relative ">
            {/* Header */}
            <div className="p-4 border-b border-primary bg-transparent backdrop-blur-3xl backdrop-brightness-50 backdrop-contrast-200  w-full  rounded-t-[20px] absolute top-0 z-10">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative">
                            <div className="size-full bg-black filter blur-xl absolute top-0 left-0 -z-10" />
                            <h3 className="text-lg font-semibold text-white">
                                {selectedContact?.name}
                            </h3>
                            <p className="text-sm text-secondary-50">Active now</p>
                        </div>
                    </div>
